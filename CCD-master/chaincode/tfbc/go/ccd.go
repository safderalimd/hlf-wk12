...
// This function is initiate by Dealer
func (s *SmartContract) issueLC(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	LC := LetterOfCredit{LCId: lc.LCId, ExpiryDate: lc.ExpiryDate, Distributor: lc.Distributor, Manufacturer: lc.Manufacturer, Dealer: lc.Dealer, Amount: lc.Amount, Status: "Issued"}
	LCBytes, err := json.Marshal(LC)
...
func (s *SmartContract) acceptLC(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	LC := LetterOfCredit{LCId: lc.LCId, ExpiryDate: lc.ExpiryDate, Distributor: lc.Distributor, Manufacturer: lc.Manufacturer, Dealer: lc.Dealer, Amount: lc.Amount, Status: "Accepted"}
	LCBytes, err := json.Marshal(LC)
